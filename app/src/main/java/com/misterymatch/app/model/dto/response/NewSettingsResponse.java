...
public class NewSettingsResponse extends BaseResponse {
    @JsonField(name = "id")
    private Integer id;
    ...
    @JsonField(name = "notification_message")
    private Integer notificationMessage;
    @JsonField(name = "notification_match")
    ...
    public NewSettingsResponse() {
    }
}*/

public class NewSettingsResponse {
