...
public class TwilloVideoActivity extends AppCompatActivity implements
        LikeDislikeFragment.OnDismissListener {

    private static final int CAMERA_MIC_PERMISSION_REQUEST_CODE = 1;
    private static final String TAG = TwilloVideoActivity.class.getSimpleName();
    private static final long ROOM_DISCONNECTION_IN_MS = 30000;
    /*
    ...
    public static boolean USE_TOKEN_SERVER = false;
    ...
    // Use this flag to identify whether the participant is either the caller or callee.
    private boolean isReceiver;

    private boolean isVideoSessionCompleted;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roomName = String.valueOf(requestId);
        participantId = extras.getInt("participant_id");
        TWILIO_ACCESS_TOKEN = extras.getString("video_token");
        isReceiver = extras.getBoolean("is_receiver", false);
        Log.d(TAG, "chatPath: " + roomName);
...
//        }
    ...
    private VideoCodec getVideoCodecPreference(String key, String defaultValue) {
        ...
        switch (videoCodecName) {
            case Vp8Codec.NAME:
                boolean simulcast =
                        preferences.getBoolean(TwilloSettingsActivity.PREF_VP8_SIMULCAST,
        ...
        return new Room.Listener() {
            ...
            public void onParticipantConnected(Room room, RemoteParticipant remoteParticipant) {
                ...
                new Timer().schedule(new TimerTask() {
                    @Override
                    public void run() {
                        runOnUiThread(TwilloVideoActivity.this::disconnectRoom);
                    }
                }, ROOM_DISCONNECTION_IN_MS);
            }

            @Override
            public void onParticipantDisconnected(Room room, RemoteParticipant remoteParticipant) {
                Log.d(TAG, "onParticipantDisconnected");
                isVideoSessionCompleted = true;
    ...
    private void fetchTwilioAccessToken() {
        customDialog.show();
        String userToken = SharedHelper.getKey(this, "access_token");
        Call<AccessToken> call = api.getTwilloVideoToken(userToken, roomName, null);
            ...
            public void onResponse(@NonNull Call<AccessToken> call,
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    Toast.makeText(
                            ...
                            getString(R.string.error_retrieving_access_token),
                            Toast.LENGTH_LONG
                    ).show();
                }
            }
    ...
    private void updateVideoCompletion() {
        customDialog.show();
        String userToken = SharedHelper.getKey(getBaseContext(), "access_token");
        Call<Object> call = GlobalData.api.updateVideoCompletion(userToken, requestId, 1);
    ...
    private void showLikeDislikeFragment() {
